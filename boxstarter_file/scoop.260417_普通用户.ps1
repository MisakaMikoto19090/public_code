...
scoop install extras/listen1desktop
...
scoop install extras/tor-browser
  ##weasel,小狼毫输入法, winget
  #scoop install extras/autohotkey
    ##autohotkey相对更好用一点
  #scoop install main/autoit
    ##autoit更多用于gui自动化
  #scoop install extras/carnac
    ##carnac可以显示键盘输入,需要.net4.5.2
  #scoop install extras/eraser
    ##eraser可以删除文件,防止恢复
...
scoop install extras/screentogif
  ...
  #scoop install extras/teamviewer
    ## 可以看看其他的
  #scoop install extras/qv2ray
    ## 淘汰了
  #scoop install nonportable/wireguard-np
    ## 不太好用,用v2rayn
  ## windows 检查更新用的update assistant , winget
...
#scoop install extras/rustrover
#scoop install extras/rubymine
